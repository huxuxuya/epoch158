...
def main() -> int:
    ...
    with open(csv_path, 'w', encoding='utf-8', newline='') as f:
        writer = csv.DictWriter(
            ...
            fieldnames=[
                ...
                'historical_inference_slot_nodes',
                'historical_inference_slot_weight',
                'lost_inference_slot_nodes',
                ...
                'historical_parent_confirmation_weight',
    ...
    for r in rows:
        ...
        lost_inf_w = max(hist_inf_w - inf_w, 0)
    ...
    with open(split_csv_path, 'w', encoding='utf-8', newline='') as f:
        writer = csv.DictWriter(
            ...
            fieldnames=[
                ...
                'historical_ml_nodes_weight_inference_slot',
                'historical_ml_nodes_weight_non_inference_slot',
                'lost_ml_nodes_weight_inference_slot',
                'historical_calculated_reward_inference_slot_nodes',
                'estimated_lost_reward_due_to_lost_inference_slots',
                'calculated_reward_inference_slot_nodes_gnk',
                'estimated_lost_reward_due_to_lost_inference_slots_gnk',
                'participant_index',
            ],
        )
        writer.writeheader()
